document.addEventListener("DOMContentLoaded", () => {
    ...
    const serviceContent = {
        ...
        three: {
            icon: "bx bx-cross",
            title: "CAD Expertise",
            text: "With over 15 years experience working with various CAD applications, my expertise include:<br><br><b><span>Technical Drawing & Drafting:</span></b><br>Creation of accurate CAD drawings, including floorplans, lease and ownership plans, M&E layouts, and UK Land Registry-compliant plans to support planning applications.<br><br><b><span>Surveying & Data Capture:</span></b><br>Conducting measured building surveys to accurately capture all architectural details and building services, ensuring the production of precise plans that reflect all captured elements.<br><br><b><span>CAD File Optimisation:</span></b><br>Streamlining CAD files for improved performance, reviewing and correcting inconstencies.<br><br><b><span>Technical Support:</span></b><br>Providing technical support for CAD applications, with hands-on experience in AutoCAD, AutoCAD Map3D and Autodesk Fusion for both drafting and CAD/CAM workflows."
        }
    };
    ...
    const testimonials = [
        ...
        {
            shortQuote: `<span class="quoteMark">“</span>His attention to detail and accuracy are 10/10 ... the real difference is his proactive nature to solve problems and overcome technical challenges<span class="quoteMark">”</span>`,
            fullQuote: `
            <p>David worked alongside my team on numerous occasions on global-scale sporting event projects - his attention to detail and accuracy are 10/10, but the real difference is David's proactive nature to also help solve problems and overcome CAD technical challenges.</p>
            <p>I would highly recommend David to anyone who needs 3D modelling and visualisation produced to high standards.</p>`,
            name: `Mark Pawley`,
            company: "Digital Twin Delivery Director, OnePlan Ltd.",
